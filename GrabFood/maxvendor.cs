...
namespace GrabFood
{
    public partial class maxvendor : Form
    {
        ...
        private void maxvendor_Load(object sender, EventArgs e)
        {
            cmbCategory.Items.Add("Max Faves");
            cmbCategory.Items.Add("Max Chicken");
            cmbCategory.Items.Add("Desserts");
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            using (SQLiteConnection conn = new SQLiteConnection(connectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@restaurant", "MAXS");
