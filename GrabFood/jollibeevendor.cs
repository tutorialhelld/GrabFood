...
namespace GrabFood
{
    public partial class jollibeevendor : Form
    {
        private string connectionString =
        @"Data Source=C:\Users\User\source\repos\GrabFood\GrabFood\bin\x64\Debug\net8.0-windows\GrabDB.db;Version=3;";

        public jollibeevendor()
        {
            InitializeComponent();
        }

        private void jollibeevendor_Load(object sender, EventArgs e)
        {
            cmbCategory.Items.Add("Jollibee Bundles");
            cmbCategory.Items.Add("Chicken Joy");
            cmbCategory.Items.Add("Jolli Desserts");
